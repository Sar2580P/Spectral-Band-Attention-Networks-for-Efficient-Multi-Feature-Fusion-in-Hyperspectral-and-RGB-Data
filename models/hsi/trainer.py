...
if config['load_model'] :
  try :
    ckpt_path = glob.glob(f"{config['dir']}/classes-{config['num_classes']}/fold-{config['fold']}/ckpts/densenet-18-24-16-10__{config['data_type']}__{config['preprocessing']}__{config['C']}--*.ckpt")[0]
